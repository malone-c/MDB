...
mdb = readxl::read_xlsx('data/MDBWaterMarketDataset_Supply_v1.1.0.xlsx', sheet =  2)
mdb$B_

# Create the design matrix
intercept = rep(1, nrow(murray))
X = as.matrix(cbind(intercept, murray[, 3:ncol(murray)]))[, -c(15, 28)]
y = log(murray$vol)
...
# REMOVE HALF THE DATA TO TEST THE ALGORITHM HERE
